...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === prefix + 'saldır aslanım') {
    msg.reply('niye');
  }
  if (msg.content.toLowerCase() === prefix + 'ets 2 haber ver') {
    msg.reply('@everyone Euro Truck Simulator 2 Gelicek Varmı?');
  }
